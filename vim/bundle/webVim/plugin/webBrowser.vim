...
" Variables {{{1
let s:lynxPath = '/usr/local/Cellar/lynx/2.8.7/bin/'
let s:lynxExe = s:lynxPath . 'lynx'
let s:lynxCfg = '-cfg=' . s:lynxPath . '../etc/lynx.cfg'
let s:lynxLss = '-lss=' . s:lynxPath . '../etc/lynx.lss'
let s:lynxCmd = s:lynxExe . ' ' . s:lynxCfg . ' ' . s:lynxLss

let g:WbLynxDumpPath = 'dump/'
let s:lynxToolsPath = 'tools/'
